...
import com.jiangyy.easydialog.utils.FontUtility;
...
//            lp.height = (int) (dm.heightPixels * 0.65);
        ...
        class ViewHolder {
            ...
            public ViewHolder(View view) {
                ...
                tvTitle.setTypeface(FontUtility.getOfficinaSansCBook(mContext));
                tvCancel.setTypeface(FontUtility.getOfficinaSansCBook(mContext));
    ...
    private static class ListAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            viewHolder.mView.setTypeface(FontUtility.getOfficinaSansCBook(mContext));
            return view;
        }
