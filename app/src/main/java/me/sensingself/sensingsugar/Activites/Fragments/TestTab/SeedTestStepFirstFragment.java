...
public class SeedTestStepFirstFragment extends Fragment {
    ...
    public static SeedTestStepFirstFragment newInstance(String param1, String param2, SeedTestStepsFragment parentFragment) {
        seedTestStepsFragment = parentFragment;
        SeedTestStepFirstFragment fragment = new SeedTestStepFirstFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_seed_tab_ts_first, container, false);
    ...
    private void initController(View rootView){
        ...
        tsImage.setImageResource(R.drawable.test_first);
        ...
        tsClock.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!isStarted){
                    ...
                    timer = new Timer();
                    timer.schedule(new timeCountTask(), 0,1000);
                }
            }
        });
    ...
    private void requestNextSteps(){
        seedTestStepsFragment.onSelectPager(1);
    }
