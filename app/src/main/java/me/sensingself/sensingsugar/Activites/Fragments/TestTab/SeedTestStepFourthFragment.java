...
public class SeedTestStepFourthFragment extends Fragment {
    ...
    public static SeedTestStepFourthFragment newInstance(String param1, String param2, SeedTestStepsFragment parentFragment) {
        seedTestStepsFragment = parentFragment;
        SeedTestStepFourthFragment fragment = new SeedTestStepFourthFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_seed_tab_ts_fourth, container, false);
    ...
    private void initController(View rootView){
        ...
        tsImage.setImageResource(R.drawable.test_fourth);
        ...
        tsClock.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!isStarted){
                    ...
                    timer = new Timer();
                    timer.schedule(new SeedTestStepFourthFragment.timeCountTask(), 0,1000);
                }
            }
        });
    ...
    private void requestNextSteps(){
        seedTestStepsFragment.gotoTakePhoto();
    }
