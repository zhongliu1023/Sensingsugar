...
public class SeedTestStepThirdFragment extends Fragment {
    ...
    public static SeedTestStepThirdFragment newInstance(String param1, String param2, SeedTestStepsFragment parentFragment) {
        seedTestStepsFragment = parentFragment;
        SeedTestStepThirdFragment fragment = new SeedTestStepThirdFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_seed_tab_ts_third, container, false);
    ...
    private void initController(View rootView){
        ...
        tsImage.setImageResource(R.drawable.test_thrid);
        ...
        tsClock.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!isStarted){
                    ...
                    timer = new Timer();
                    timer.schedule(new SeedTestStepThirdFragment.timeCountTask(), 0,1000);
                }
            }
        });
    ...
    private void requestNextSteps(){
        seedTestStepsFragment.onSelectPager(3);
    }
