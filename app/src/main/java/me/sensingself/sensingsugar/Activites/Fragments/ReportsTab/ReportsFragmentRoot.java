...
public class ReportsFragmentRoot extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_note_tab_root, container, false);
        ...
        transaction.replace(R.id.note_root_frame, new ReportsFragment());
