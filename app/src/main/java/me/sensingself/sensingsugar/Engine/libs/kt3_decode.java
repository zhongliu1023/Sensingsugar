...
public class kt3_decode {
    ...
    public Map<String, Object> kt3_extract_plastic(Image image, Bitmap currentImage)
    {
        ...
        dest.init(0, 0, 1200, 300);

        //TODO:add this back in
        returnResult.put("plastic", plastic);
        returnResult.put("dest", image.resize(src, dest, currentImage));
        return returnResult;
    }
...
glucose_y    = 150;
 */
        int background_x = GLOBAL_BACKGROUND_X;
        int background_y = 150;
// change from 770 to GLOBAL_SIGNAL_X
        int glucose_x  = GLOBAL_SIGNAL_X;
        int glucose_y  = 150;
        int ph_x       = 397;
        int ph_y       = 150;
        int qr_white_x = 845;
        ...
        int calib1_x   = 306;
        int calib1_y   = 80;
        int calib2_x   = calib1_x;
        int calib2_y   = 155;
        int calib3_x   = calib1_x;
        int calib3_y   = 234;
        //
        //      Find plastic 1
        //
...
//print_r(colors_row);
        ...
        dec_row.put("dec_plastic1_value", (int)value);
...
//print_r(colors_row);
        ...
        dec_row.put("dec_plastic2_value", (int)value);
