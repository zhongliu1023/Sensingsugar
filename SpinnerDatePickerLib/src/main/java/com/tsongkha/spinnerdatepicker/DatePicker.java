...
public class DatePicker extends FrameLayout {
    ...
    DatePicker(ViewGroup root, int numberPickerStyle) {
        ...
        mDaySpinnerInput.setTypeface(FontUtility.getOfficinaSansCBold(root.getContext()));
        mMonthSpinnerInput.setTypeface(FontUtility.getOfficinaSansCBold(root.getContext()));
        mYearSpinnerInput.setTypeface(FontUtility.getOfficinaSansCBold(root.getContext()));
